...
<head>
    ...
    <style> 
        table { 
            background-color: <?php echo $_POST["colorFondo"]; ?>;
            color: <?php echo $_POST["colorLetra"]; ?>;
            table-layout: fixed;
            width: 100%;
...
<body><!--Con Style APARTE-->
    ...
    if (isset($_POST["nFilas"]) && isset($_POST["nColumnas"]) && isset($_POST["colorFondo"]) && isset($_POST["colorLetra"])) {
        ...
        crear_tabla($_POST["nFilas"], $_POST["nColumnas"]);
     ...
     */
    function crear_tabla($nFilas, $nColumnas)
    {
